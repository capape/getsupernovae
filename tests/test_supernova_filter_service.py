    ...
    def getVisibility(self, site, coord, t1, t2):
        ...
        if is_visible:
            return Visibility(True, [
                AxCordInTime(t1, None),
                AxCordInTime(t1 + timedelta(hours=1), None)
            ])
        else:
...
def test_filter_by_visibility():
    ...
    visible = service.filter_by_visibility(
        supernovae, site, obs_start, obs_end,
        min_altitude=0, max_altitude=90, min_azimuth=0, max_azimuth=360
    )
