    ...
    def getVisibility(self, site, coord, t1, t2):
        ...
        if ra_hours > 12.0:
            ...
            return Visibility(True, [
                AxCordInTime(start_time, None),
                AxCordInTime(end_time, None)
            ])
        else:
...
def test_sort_by_observation_time():
    ...
    sn1 = Supernova(
        name="SN2025a", date="2025/01/01", mag="14.0", host="Host1",
        ra="12:00:00", decl="+45:00:00", link="", constellation="Leo",
        coordinates=None, firstObserved=None, maxMagnitude=None,
        maxMagnitudeDate=None, type="Ia",
        visibility=Visibility(True, [
            AxCordInTime(datetime(2025, 1, 1, 22, 0, 0), None),
            AxCordInTime(datetime(2025, 1, 1, 23, 0, 0), None)
        ]),
        maxMagnitudeDate_obj=None, firstObserved_obj=None
    )
    
    sn2 = Supernova(
        name="SN2025b", date="2025/01/01", mag="14.0", host="Host2",
        ra="12:00:00", decl="+45:00:00", link="", constellation="Leo",
        coordinates=None, firstObserved=None, maxMagnitude=None,
        maxMagnitudeDate=None, type="Ia",
        visibility=Visibility(True, [
    ...
    sn3 = Supernova(
        name="SN2025c", date="2025/01/01", mag="14.0", host="Host3",
        ra="12:00:00", decl="+45:00:00", link="", constellation="Leo",
        coordinates=None, firstObserved=None, maxMagnitude=None,
        maxMagnitudeDate=None, type="Ia",
        visibility=Visibility(True, [
...
def test_group_by_constellation():
    ...
    sn1 = Supernova(
        ...
        ra="12:00:00", decl="+45:00:00", link="", constellation="Leo",
        coordinates=None, firstObserved=None, maxMagnitude=None,
        maxMagnitudeDate=None, type="Ia", visibility=None,
        maxMagnitudeDate_obj=None, firstObserved_obj=None
    )
    
    sn2 = Supernova(
        name="SN2025b", date="2025/01/01", mag="14.0", host="Host2",
        ra="12:00:00", decl="+45:00:00", link="", constellation="Virgo",
        coordinates=None, firstObserved=None, maxMagnitude=None,
        maxMagnitudeDate=None, type="Ia", visibility=None,
        maxMagnitudeDate_obj=None, firstObserved_obj=None
    )
...
def test_filter_by_observation_quality():
    ...
    filtered = service.filter_by_observation_quality(
        supernovae,
        min_altitude=30.0,
        min_observation_duration_minutes=30.0
    )
